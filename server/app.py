...
def create_baked_goods():
    ...
    db.session.commit()
    return make_response(new_object.to_dict(),201)
...
def delete_baked_good(id):
    ...
    if baked_good:
        if request.method=="DELETE":
            ...
            db.session.commit()
            return make_response({"Message":"Baked_good deleted successfully"},200)
    # @app.route('/bakeries')
# def bakeries():
...
#       response=make_response(bakery_serialized)
#       return response
...
#             db.session.add(bakery)
#             db.session.commit()
#             bakery_serialized1=bakery.to_dict()            
...
#     db.session.commit()
#     response_message={
#         "Message":"Baked_good deleted successfully"
#     }
